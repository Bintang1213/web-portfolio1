...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    hidden'>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
            <Image src={isDarkMode ? assets.logo : assets.logo} className='w-28 alt="" 
        ...
        rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"} `}>
            ...
            <li><a className='font-Ovo' href="#My Job">My Job</a></li>
            <li><a className='font-Ovo' href="#Kontak">Kontak Saya</a></li>
        </ul>
  ...
  <Image src={isDarkMode ? assets.menu_white : assets.menu_black} alt='' className='w-6' />
    ...
    <li><a className='font-Ovo' href="#top">Beranda</a></li>
            <li><a className='font-Ovo' onClick={closeMenu} href="#About">Tentang Saya</a></li>
            <li><a className='font-Ovo' onClick={closeMenu} href="#Services">Services</a></li>
            <li><a className='font-Ovo' onClick={closeMenu} href="#My Job">My Job</a></li>
            <li><a className='font-Ovo' onClick={closeMenu} href="#Kontak">Kontak Saya</a></li>
    </ul>
      </nav>
    </>
  )
