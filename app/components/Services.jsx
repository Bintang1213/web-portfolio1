...
const Services = () => {
  return (
    ...
    id='Services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center text-8xl font-Ovo'>
       ...
       I am a Software Engineering student with a strong passion for web development. During my studies, I have explored and developed various projects using modern technologies like HTML, CSS, JavaScript, React.js, and Node.js.
       </motion.p>
